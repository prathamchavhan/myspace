...
export default function Hero() {
    ...
    return (
        <section className="relative z-0 isolate min-h-screen w-full flex items-center overflow-hidden bg-[#f5f5f3] dark:bg-black transition-colors duration-500 font-mono">
